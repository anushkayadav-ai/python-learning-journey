...
I am an aspiring AI Engineer from India, currently learning Python and preparing for future studies in Artificial Intelligence and Machine Learning.

## Goals
- Learn Python Fundamentals
- Build Programming Projects
- Learn AI and Machine Learning
- Prepare for the GKS Scholarship
...
- Used the `random` module for the computer's move
- Validated user input
